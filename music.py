...
window = tk.Tk()
window.title("Esnile Mp3 Player")
window.iconbitmap('img/player.ico')
window.geometry("600x500")

# Create a label for the music player title
l_music_player = tk.Label(window, text="Esnile Mp3 Player", font=("TkDefaultFont", 30, "bold"))
...
btn_play = ctk.CTkButton(btn_frame, text="▶", command=play_music, width=50,
                         font=("TkDefaultFont", 18))
